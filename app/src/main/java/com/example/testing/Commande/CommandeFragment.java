...
public class CommandeFragment extends Fragment {
 ...
 private Button allButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button FAccButton = v.findViewById(R.id.FAccept);
        FAccButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                System.out.println("facture accepte");
                ApiCom api = ApiClient.getClient().create(ApiCom.class);
                Call<List<commande>> listComByClientSP = api.getFactByIdClientAcc(1);
                listComByClientSP.enqueue(new Callback<List<commande>>() {
                    @Override
 ...
 /*                   for (int i=0; i<length; i++)
        ...
        Button FPartielButton = v.findViewById(R.id.FPartiel);
        FPartielButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                System.out.println("facture EnCours");
                ApiCom api = ApiClient.getClient().create(ApiCom.class);
                Call<List<commande>> listComByClientSEC = api.getFactByIdClientPar(1);
                listComByClientSEC.enqueue(new Callback<List<commande>>() {
                    @Override
                    public void onResponse(Response<List<commande>> response, Retrofit retrofit) {
                        List<commande> listcom = new ArrayList<commande>();
                        if(response.isSuccess())
 ...
 /*                   for (int i=0; i<length; i++)
        ...
        Button FRefuseButton = v.findViewById(R.id.FRefuse);
        FRefuseButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                System.out.println("facture Refuser");
                ApiCom api = ApiClient.getClient().create(ApiCom.class);
                Call<List<commande>> listComByClientRef = api.getFactByIdClientRef(1);
                listComByClientRef.enqueue(new Callback<List<commande>>() {
                    @Override
                    public void onResponse(Response<List<commande>> response, Retrofit retrofit) {
                        List<commande> listcom = new ArrayList<commande>();
                        if(response.isSuccess())
...
Button allButton= v.findViewById(R.id.Fall);
allButton.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        System.out.println("All fatouraaaat");
        ApiCom api = ApiClient.getClient().create(ApiCom.class);
